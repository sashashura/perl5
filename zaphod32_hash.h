...
/* This is two marsaglia xor-shift permutes, with a prime-multiple sandwiched
 * inside. The end result of doing this twice with different primes is a
 * completely avalanched v. */
...
void zaphod32_seed_state (
    ...
    /* now that we have scrambled we do some mixing to avalanche the state bits
     * to gether */
